            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <div className="about-tab" style={{"paddingTop":"0px"}}>
                  ...
                  <div className="bar" />
                  <p>
                  At RisingCapitalist, we believe that everyone should have the opportunity to invest in startups. That's why we've created an online platform that makes it easy for investors to find and invest in startups with high growth potential.
                  </p>
                  <p>
                  We also believe that startups are the key to economic growth and innovation. That's why we're committed to helping startups raise the funds they need to succeed.
                  </p>
                  <p>
                  Our mission is to empower startups and investors by providing a dynamic online platform that not only connects visionaries with capital but also equips entrepreneurs with the essential financial and legal services they need to thrive. We are dedicated to fuelling innovation, fostering growth, and making the journey of fundraising more accessible and successful for startups.
                  </p>
                  <div className="tab about-list-tab">
                    ...
                    <div className="tab_content">
                      <div className="tabs_item">
                        <p>
                          <b>1.	Facilitating Connections: </b> We are committed to creating a vibrant digital ecosystem where startups can meet investors, where ideas can find support, and where dreams can become reality. We strive to bridge the gap between brilliant concepts and the resources required to bring them to life.
                        </p>
                        <p>
                          <b>2.	Empowering Entrepreneurs: </b> We believe in the potential of startups to drive change. Our CFO services empower startups with financial expertise, while our legal services secure their fundraising endeavours. The addition of "Invoice Discounting" further strengthens our financial support by offering cash flow solutions that help startups maintain stability.
                        </p>
                        <p>
                          <b>3.	Simplifying Fundraising: </b> We aim to simplify the fundraising process, making it more accessible and less intimidating. Our platform provides a user-friendly experience that allows startups to focus on their innovation, and investors to discover promising opportunities effortlessly.
                        </p>
                        <p>
                          <b>4.	Fostering Innovation: </b> Our passion lies in nurturing innovation. We are driven to foster a community of innovators, thinkers, and doers who are shaping the future. We take pride in being an essential part of their journey.
                        </p>
              ...
              <div className="col-lg-6 col-md-6 col-sm-6">
                <div className="team-item">
                  <div className="image">
                    ...
                    /> */}
                    <img
                      src={process.env.NEXT_PUBLIC_BASE_URL+'assets/images/anjul-gupta.png?auto=format&fit=crop&w=500&q=60'}
                      alt="image"
                    />
                    <ul className="social">
                      <li>
                  ...
                  <div className="content" style={{"textAlign":"left"}}>
                    <p>Anjul is a CFA charterholder and an MBA in Finance. He specializes in Business Valuation and an alumnus of Deloitte and Duff & Phelps. Currently, he oversees the business’s overall operations and strategy.</p>
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-md-6 col-sm-6">
                <div className="team-item">
                  <div className="image">
                    ...
                    /> */}
                    <img
                      src={process.env.NEXT_PUBLIC_BASE_URL+'assets/images/megha-agarwal.png?auto=format&fit=crop&w=500&q=60'}
                      alt="image"
                    />
                    <ul className="social">
                      <li>
                  ...
                  <div className="content" style={{"textAlign":"left"}}>
                    <p>CA Megha Agarwal is Fellow Member of Institute of Chartered Accountants of India. She has 19 years of experience of CA Practice in the area of Direct & Indirect Taxation and Auditing.  She oversees the finance & operations functions in the Company.</p>
                  </div>
                </div>
              </div>
