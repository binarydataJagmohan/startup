      ...
      <section className="team-section pt-100 pb-100">
        <div className="container">
          <div className="section-title">
            ...
            <p>
              At our startup and investment website, we are proud to have
              assembled a team of experts with decades of combined experience in
              the financial industry. Our team includes professionals from a
              range of backgrounds, including finance, economics, technology,
              and more.
            </p>
            <div className="bar" />
          </div>
