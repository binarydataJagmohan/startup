          ...
          <div className="copyright-area-content">
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 col-md-6">
                <ul>
                  <li>
                    <Link href="/terms-condition" style={{ color: "#666" }}>
                      Terms & Conditions
                    </Link>
                  </li>
                  <li>
                    <Link href="/risk-investments" style={{ color: "#666" }}>
                      Risk Of Investments
                    </Link>
                  </li>
                  <li>
                    <Link href="/privacy-policy" style={{ color: "#666" }}>
                      Privacy Policy
                    </Link>
                  </li>
                </ul>
          ...
          <div className="disclaimer-area-content">
            <div className="row align-items-center">
              <div className="col-lg-12 col-md-12">
                <p className="m-0 mb-2" style={{ fontSize: "14px" }}>
                  <strong> Disclaimer:</strong> RisingCapitalist is NOT a stock
                  exchange recognised by the Securities Exchange Board of India
                  (SEBI) under the securities contract (regulation) act, 1956.
                  RisingCapitalist does not allow any secondary market trading
                  of securities on the Platform. Information presented on this
