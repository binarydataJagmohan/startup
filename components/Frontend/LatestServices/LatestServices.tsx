        ...
        <>
            <section className="faq-section ptb-100">
                <div className="container">
                                ...
                                <div className='col-lg-8'>
                                    <div className='row'>
                                        <div className='col-lg-6'>
                                            <p>Shareholder Agreement Drafting</p>
                                            <p style={{ background: '#ccc' }}>Issuance of Share Certificates</p>
                                            <p>Valuation by Registered Valuer</p>
                                        </div>
                                        <div className='col-lg-6 p-0'>
                                            <p>Legal Services</p>
                                            <p style={{ background: '#ccc' }}>Term Sheet Review</p>
                                            <p>Valuation by Merchant Banker</p>
                                        </div>
                                    </div>
                                </div>
                                <div className='col-lg-4'></div>
                    ...
                    <div className="virtual_cfo mt-5">
