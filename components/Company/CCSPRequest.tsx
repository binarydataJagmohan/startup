...
const CCSPRequest = () => {
    ...
    const submitIfinWorthDetails = async (e: any) => {
        ...
        try {
            ...
            formData.append("ifinworth_fund_name", user.ifinworth_fund_name);
                            ...
                            <div className="col-sm-12">
                                <div className="row">
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <div className="row">
                                            <div className="col-sm-12">
                                            <input type="text" name="ifinworth_fund_name" className="form-control fild-des" placeholder="Enter fund name" value={
                                            user.ifinworth_fund_name
                                                ? user.ifinworth_fund_name
                                                : ""
                                        } onChange={handleInputChange} />
                                            </div>
