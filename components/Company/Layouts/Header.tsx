  ...
  <div className="navbar-header">
    <div className="d-flex">
      ...
      <div className="navbar-brand-box">
        <a href={process.env.NEXT_PUBLIC_BASE_URL+"/company/dashboard"} className="logo logo-dark">
          <span className="logo-sm">
            <img src={process.env.NEXT_PUBLIC_BASE_URL+"assets/img/logo.png"} alt="" height={22} />
          </span>
          <span className="logo-lg">
            <img src={process.env.NEXT_PUBLIC_BASE_URL+"assets/img/logo.png"} alt="" height={17} />
          </span>
        </a>
        <a href="index.html" className="logo logo-light">
          ...
          <span className="logo-lg">
            <img src={process.env.NEXT_PUBLIC_BASE_URL+"assets/img/logo.png"} alt="" height={18} />
          </span>
        </a>
      </div>
    </div>
