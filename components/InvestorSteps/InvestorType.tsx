...
export default function InvestorType(): any {
  ...
  const [financial_annual_net_worth, setFinancialAnnualNetWorth]: any =
    useState(false);
  ...
  const [foreign_annual_net_worth, setForeignAnnualNetWorth]: any =
    useState(false);
  ...
  useEffect(() => {
    ...
    if (current_user_data.id) {
      let go_back_btn_val = localStorage.getItem(
  ...
  const SubmitForm = async (e: any) => {
    ...
    if (selectedOption === "1") {
      ...
      if (
        annual_income == false &&
        financial_net_worth == false &&
        financial_annual_net_worth == false
      ) {
                      ...
                      <div className="row justify-content-center">
                        <div className="col-md-8" id="register">
                              ...
                              <div className="row">
                                <div className="col-md-12">
                                  ...
                                  >
                                    ...
                                    <option value="2">
                                      Body Corporate/VC/PE/Family
                                      Office/Corporate Institution
                                    </option>
                                    <option value="3">
                                  ...
                                  >
                                      ...
                                      <div className="row">
                                        ...
                                        <div className="col">
                                          <label htmlFor="checkbox4">
                                            Net tangible assets of at least INR
                                            2 Crore excluding value of his
                                            principal residence.
                                      ...
                                      <div className="row">
                                        <div className="col-auto pt-1">
                                          <input
                                            ...
                                            value={
                                              prev_investment_exp == 0 ? 1 : 0
                                            }
                                            onChange={() =>
                                              setPrevInvestmentExp(
                                                !prev_investment_exp
                                              )
                                            }
                                            checked={
                                      ...
                                      <div className="row">
                                        <div className="col-auto pt-1">
                                          <input
                                            type="checkbox"
                                            id="checkbox6"
                                            value={cofounder == 0 ? 1 : 0}
                                            name="cofounder"
                                            onChange={() =>
                                              setCofounder(!cofounder)
                                            }
                                            checked={
                                              cofounder == 0 ? false : true
                                            }
                                          />
                                        </div>
                                        <div className="col">
                                          <label htmlFor="checkbox6">
                                            ...
                                            or have been a founder/co-founder of
                                            a business venture
                                          </label>
                                        </div>
                                      </div>
                                      ...
                                      <div className="row">
                                        <div className="col-auto pt-1">
                                          <input
                                            type="checkbox"
                                            id="checkbox7"
                                            value={experience == 0 ? 1 : 0}
                                            name="experience"
                                            onChange={() =>
                                              setExperience(!experience)
                                            }
                                            checked={
                                              experience == 0 ? false : true
                                            }
                                          />
                                        </div>
                                        <div className="col">
                                    ...
                                    <div className="same-card checkbox-options">
                                      <div className="row">
                                        <p>
                                          <span
                                            className="small mb-2 d-inline-block"
                                      ...
                                      <div className="row">
                                        <div className="col-auto pt-1">
                                          <input
                                            type="checkbox"
                                            id="checkbox8"
                                            value={net_worth == 0 ? 1 : 0}
                                            name="net_worth"
                                            onChange={() =>
                                              setNetWorth(!net_worth)
                                            }
                                            checked={
                                              net_worth == 0 ? false : true
                                            }
                                          />
                                        </div>
                                        <div className="col">
                              ...
                              <div className="row">
                                <div className="col-md-12">
                                  ...
                                  >
                                    ...
                                    <option value="4">
                                      Indian Individuals/HUFs/Family Trusts/Sole
                                      Proprietorships
                                    </option>
                                    <option value="5">
                                      Foreign Individuals/Family Trusts/Sole
                                      Proprietorships
                                    </option>
                                      ...
                                      <div className="row">
                                        <div className="col-auto pt-1">
                                          <input
                                            type="checkbox"
                                            id="checkbox10"
                                            value={annual_income == 0 ? 1 : 0}
                                            name="annual_income"
                                            checked={
                                              annual_income == 0 ? false : true
                                            }
                                            onChange={(e: any) =>
                                        ...
                                        <div className="col">
                                          <label htmlFor="checkbox10">
                                            Have an annual income of at least ₹2
                                      ...
                                      <div className="row">
                                        ...
                                        <div className="col">
                                          <label htmlFor="checkbox11">
                                            Have a net worth of at least ₹7.5
                                            crore with more than ₹3.75 crore of
                                            financial assets.
                                          </label>
                                        </div>
                                      </div>
                                      ...
                                      <div className="row">
                                        <div className="col-auto pt-1">
                                          <input
                                            ...
                                            name="financial_annual_net_worth"
                                            checked={
                                              financial_annual_net_worth == 0
                                                ? false
                                                : true
                                        ...
                                        <div className="col">
                                          <label htmlFor="checkbox12">
                                            Have an annual income of at least ₹1
                                            crore and a net worth of at least ₹
                                            5 crore with more than ₹ 2.5 crore
                                            of financial assets.
                                          </label>
                                        </div>
                                      </div>
                                      ...
                                      <div className="row">
                                        <div className="col-auto pt-1">
                                          <input
                                            ...
                                            id="checkbox13"
                                            value={
                                              foreign_annual_income == 0 ? 1 : 0
                                            }
                                            name="foreign_annual_income"
                                            checked={
                                        ...
                                        <div className="col">
                                          <label htmlFor="checkbox13">
                                            Have an annual income of at least
                                            $300,000.
                                          </label>
                                          <br></br>
                                      ...
                                      <div className="row">
                                        <div className="col-auto pt-1">
                                          <input
                                            ...
                                            id="checkbox14"
                                            value={
                                              foreign_net_worth == 0 ? 1 : 0
                                            }
                                            name="foreign_net_worth"
                                            checked={
                                              foreign_net_worth == 0
                                                ? false
                                                : true
                                        ...
                                        <div className="col">
                                          <label htmlFor="checkbox14">
                                            Have a net worth of at least $1
                                            million with more than $500,000 of
                                            financial assets.
                                          </label>
                                        </div>
                                      </div>
                                      ...
                                      <div className="row">
                                        ...
                                        <div className="col">
                                          <label htmlFor="checkbox15">
                                            Have an annual income of at least
                                            $150,000 and a net worth of at least
                                            $750,000 with more than $350,000 of
                                            financial assets.
                                          </label>
                                        </div>
                                      </div>
                          ...
                          <div className="row mt-3">
                            ...
                            >
                              <button className="btnclasssmae">Submit</button>
                            </div>
                          </div>
                        </div>
                      </div>
