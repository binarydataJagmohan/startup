...
export default function Chats(props: any) {
  ...
  const imageChange = async (e: any) => {
    ...
    formData.append('message_type', chat_type);
                                          ...
                                          <div className="col-lg-3 col-md-3 col-3 pr-0">
                                            <div className="position-relative">
                                              {message.sender_pic == null ? (
                                                <Image height={38} width={38} src={process.env.NEXT_PUBLIC_IMAGE_URL + '/images/users.jpg'} alt="chats-user" />
                                              ) : (
                                                <Image height={38} width={38} src={process.env.NEXT_PUBLIC_IMAGE_URL + '/images/profile/' + message.sender_pic} alt="chats-user" />
                                              )}
                              ...
                              {adminuserchefmesage.length > 0 ? (
                                adminuserchefmesage.map((message, index) => (
                                  <React.Fragment key={index}>
                                    ...
                                    {(message.sender_role == 'investor' || message.sender_role == 'startup') && (
                                      <li className="reply">
                                        {message.sender_pic == null ? <Image
                                          src={process.env.NEXT_PUBLIC_BASE_URL + 'images/user.jpg'}
                                          alt="chats-user" width={38} height={38}
                                        /> : <Image
                                    ...
                                    {(message.sender_role == 'admin') && (
                                      <li className="reply-two">
                                        <span className="bg-f1">
                                          {message.message_attachment_type === 'image' && <a href={process.env.NEXT_PUBLIC_IMAGE_URL + '/images/chat/images/' + message.message} target="_blank" rel="noopener noreferrer">  <Image
                                            src={process.env.NEXT_PUBLIC_IMAGE_URL + '/images/chat/images/' + message.message_attachment}
                                            className="chat_shared_image"
                                        ...
                                        {currentUserData.profile_pic == null ? <Image
                                          src={process.env.NEXT_PUBLIC_IMAGE_URL + '/images/users.jpg'}
                                          alt="chats-user" height={38} width={38}
                                        /> : <Image
                                          src={process.env.NEXT_PUBLIC_IMAGE_URL + '/images/profile/' + currentUserData.profile_pic}
                                          alt="chats-user" height={38} width={38}
                                        />}
                              ...
                              {chat_type == 'single' && adminuserchefmesage.length > 0 && (
                                <>
                                  {adminuserchefmesage.slice(0, 1).map((message, index) => (
                                    <React.Fragment key={index}>
                                      <p className="g-text">
                                        {currentUserData.profile_pic == 'null' ? (
                                          <Image
                                            src={process.env.NEXT_PUBLIC_IMAGE_URL + '/images/users.jpg'}
                                            alt="chats-user" height={38} width={38}
                                          />
                          ...
                          <div className="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <div className="sp-4 tab_share_file">
                              <ul className="user-mess" id="asd">
                                {
                                  adminuserchefmesage.some((message) => message.message_attachment_type !== null) ? (
                                    <>
                                      {adminuserchefmesage
                                        .filter((message) => message.message_attachment_type !== null && message.chatdate)
                                        .sort((a, b) => {
                                      ...
                                      {adminuserchefmesage.filter((message) => message.message_attachment_type !== null && message.chatdate).length === 0 && (
                                        <p>No data found.</p>
                                      )}
                                    </>
                                  ) : (
              ...
              <div className="all-form" id="chat_group_form">
                <form onSubmit={handlGroupSubmit} className="common_form_error" id="menu_form">
                  ...
                  <div className="container p-0 login_div">
                    <div className="row">
                      <div className="col-4">
                        <label className="mb-3 mt-1" htmlFor="Image">Select Investor:</label>
                        {Array.isArray(userdata) && userdata.filter(user => user.role === 'investor').length > 0 ? (
                          userdata.filter(user => user.role === 'investor').map((user, index) => (
                      ...
                      <div className="col-4">
                        <label className="mb-3 mt-1" htmlFor="Image">Select Startup:</label>
                        {Array.isArray(userdata) && userdata.filter(user => user.role === 'startup').length > 0 ? (
                          userdata.filter(user => user.role === 'startup').map((user, index) => (
                            <div className="checkbox d-flex" key={index}>
                              <input
                                id={`flexCheckDefault${index}`}
                                value="4"
