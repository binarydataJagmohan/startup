                                                    ...
                                                    <div className="row">
                                                        <div className="col-auto pt-1">
                                                            <input type="checkbox" id="checkbox5"
                                                                ...
                                                                value={prev_investment_exp == 0 ? 0 : 1} onChange={() => setPrevInvestmentExp(!prev_investment_exp)} checked={prev_investment_exp == 0 ? false : true} disabled/>
                                                        </div>
                                                        <div className="col">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-auto pt-1">
                                                            <input type="checkbox" id="checkbox6" value={cofounder == 0 ? 0 : 1}
                                                                name="cofounder" onChange={() => setCofounder(!cofounder)} checked={cofounder == 0 ? false : true} disabled/>
                                                        </div>
                                                        <div className="col">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-auto pt-1">
                                                            <input type="checkbox" id="checkbox7" value={experience == 0 ? 0 : 1}
                                                                name="experience" onChange={() => setExperience(!experience)} checked={experience == 0 ? false : true} disabled/>
                                                        </div>
                                                        <div className="col">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-auto pt-1">
                                                            <input type="checkbox" id="checkbox8" value={net_worth == 0 ? 0 : 2}
                                                                name="net_worth" onChange={() => setNetWorth(!net_worth)} checked={net_worth == 0 ? false : true} disabled/>
                                                        </div>
                                                        <div className="col">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-auto pt-1">
                                                            <input type="checkbox" id="checkbox9" value={no_requirements == 0 ? 0 : 3}
                                                                name="no_requirements" onChange={() => setNoRequirements(!no_requirements)} checked={no_requirements == 0 ? false : true} disabled/>
                                                        </div>
                                                        <div className="col">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-auto pt-1">
                                                            <input type="checkbox" id="checkbox10" value={annual_income == 0 ? 0 : 4}
                                                                ...
                                                                onChange={(e: any) => setAnnualIncome(!annual_income)} disabled/>
                                                        </div>
                                                        <div className="col">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-auto pt-1">
                                                            <input type="checkbox" id="checkbox12" value={financial_annual_net_worth == 0 ? 0 : 6}
                                                                ...
                                                                onChange={(e: any) => setFinancialAnnualNetWorth(!financial_annual_net_worth)} disabled/>
                                                        </div>
                                                        <div className="col">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-auto pt-1">
                                                            <input type="checkbox" id="checkbox13" value={foreign_annual_income == 0 ? 0 : 7}
                                                                ...
                                                                onChange={(e: any) => setForeignAnnualIncome(!foreign_annual_income)} disabled/>
                                                        </div>
                                                        <div className="col">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-auto pt-1">
                                                            <input type="checkbox" id="checkbox14" value={foreign_net_worth == 0 ? 0 : 8} name="foreign_net_worth" checked={foreign_net_worth == 0 ? false : true}
                                                                onChange={(e: any) => setForeignNetWorth(!foreign_net_worth)} disabled/>
                                                        </div>
                                                        <div className="col">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-auto pt-1">
                                                            <input type="checkbox" id="checkbox15" value={foreign_annual_net_worth == 0 ? 0 : 9}
                                                                ...
                                                                onChange={(e: any) => setForeignAnnualNetWorth(!foreign_annual_net_worth)} disabled/>
                                                        </div>
                                                        <div className="col">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-auto pt-1">
                                                            <input type="checkbox" id="checkbox16" value={corporate_net_worth == 0 ? 0 : 10} checked={corporate_net_worth == 0 ? false : true}
                                                                onChange={(e: any) => setCorporateNetWorth(!corporate_net_worth)} disabled/>
                                                        </div>
                                                        <div className="col">
