...
const Payment = () => {
    ...
    useEffect(() => {
        if (bookingdata.business_id) {
            getBusinessInformationBusinessId(bookingdata.business_id)
                .then((res) => {
                    if (res.status === true) {
                    ...
                    <div id="Checkout" className="inline">
                        ...
                        <form onClick={handleSubmit(SubmitForm)}>
                            ...
                            <div className="row mb-3">
                                <div className="col-md-6 form-group mb-3">
                                    ...
                                    <div className="amount-placeholder">
                                        <span>$</span>
                                        <span>{bookingdata.repayment_value}</span>
                                    </div>
                                </div>
                                <div className="col-md-6 form-group mb-3">
                                <label htmlFor="PaymentAmount">Total Units</label>
                                <div className="amount-placeholder">
                                    <input type="text" className="form-control" value={bookingdata.no_of_units} disabled />
                                </div>
                            </div>
                            ...
                            <div className="form-group mb-3">
                                ...
                                <input id="CreditCardNumber" className="null card-image form-control" {...register("card_number", {required:true
                            })} type="text" maxLength={16} />
                            </div>
                            <div className="expiry-date-group form-group mb-3">
                                <label htmlFor="ExpiryDate">Expiry date</label>
                                <input id="ExpiryDate" className="form-control" type="text" placeholder="MM / YY" maxLength={5} />
                            </div>
