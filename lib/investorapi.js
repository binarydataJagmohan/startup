...
export const addPreCommitedInvestor = async (data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request({
      url: process.env.NEXT_PUBLIC_API_URL + '/add-pre-commited-investor',
      method: 'post',
      headers: {
        'Accept': 'application/json',
        'Authorization': 'Bearer ' + getToken(),
...
export const deletePreCommitedinvestor = async (id) => {
  try {
    const response = await axios.post(
      process.env.NEXT_PUBLIC_API_URL + "/delete-pre-commited-investor/" + id,
      {
        headers: {
          Accept: "application/json",
          Authorization: "Bearer " + getToken(),
...
export const getPreCommitedInvestor = async (id) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/get-pre-commited-investors/' + id, {
      method: 'get',
      headers: {
        'Accept': 'application/json',
        'Authorization': 'Bearer ' + getToken()
...
export const getSingleIfinworthdata = async (id) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/get-single-data-ifinworth-data', {
      method: 'get',
      headers: {
        'Accept': 'application/json',
        'Authorization': 'Bearer ' + getToken()
      },
      params: { id } // Include the 'id' as a parameter in the request
    });
