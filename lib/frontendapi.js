...
export const uploadDocuments = async (data, pan_card_front,pan_card_back,adhar_card_front,adhar_card_back, certificateIncorporation, bankStatementThreeYears, MOA, AOA) => {
...
export const getFailerErrorLog = async data => {
  ...
  export const deleteerrorlog= async (data) => {
    ...
    export const verifyEmailOtp = async(data) => {
        return new Promise((resolve, reject) => {
            const req = axios.request(`${process.env.NEXT_PUBLIC_API_URL}/confirm-email-otp`, {
                method: 'post',
                headers: {
                    Accept: "application/json",
                },
    ...
    export const panVerification = async(panNo) => {
        return new Promise((resolve, reject) => {
            const req = axios.request('https://pan-card-verification-at-lowest-price.p.rapidapi.com/verifyPan/'+panNo, {
                method: 'GET',
                headers: {
                    'x-rapid-api': 'rapid-api-database',
                    'X-RapidAPI-Key': 'f1f388a396msh4627e8026ca1e90p132b72jsnef6a3aeb06d6',
    ...
    export const aadharVerification = async(data) => {
        return new Promise((resolve, reject) => {
            const req = axios.request('https://verifyaadhaarnumber.p.rapidapi.com/Uidverifywebsvcv2/VerifyAadhaarNumber', {
                method: 'GET',
                headers: {
