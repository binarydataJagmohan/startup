...
export const CreateTermsAndConditionByAdmin = async (data) => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/terms-and-conditions-by-admin', {
			method: 'post',
			headers: {
				Accept: 'application/json',
...
export const getSingleBusinessUnitInfo = async (id) => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/get-single-buisness-unit/' + id, {
			method: 'get',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const AdminAddCampaignDetail = async (data) => {
	return new Promise((resolve, reject) => {
		const req = axios.post(process.env.NEXT_PUBLIC_API_URL + '/admin-add-campaign-detail', data, {
			method: 'post',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const AdminAddCometitorCompany = async (data) => {
	...
	return new Promise((resolve, reject) => {
		const req = axios.post(process.env.NEXT_PUBLIC_API_URL + '/admin-add-campany-data', data, headers);
		req.then((res) => resolve(res.data)).catch((err) => reject(err));
	});
};
...
export const AdminUpdateCometitorCompany = async (data) => {
	...
	return new Promise((resolve, reject) => {
		const req = axios.post(process.env.NEXT_PUBLIC_API_URL + '/admin-update-campany-data', data, headers);
		req.then((res) => resolve(res.data)).catch((err) => reject(err));
	});
};
...
export const AdminAddTeamMember = async (data) => {
	...
	return new Promise((resolve, reject) => {
		const req = axios.post(process.env.NEXT_PUBLIC_API_URL + '/admin-add-team-members', data, headers);
		req.then((res) => resolve(res.data)).catch((err) => reject(err));
	});
};
...
export const AdminUpdateTeamMember = async (data) => {
	...
	return new Promise((resolve, reject) => {
		const req = axios.post(process.env.NEXT_PUBLIC_API_URL + '/admin-update-team-data', data, headers);
		req.then((res) => resolve(res.data)).catch((err) => reject(err));
	});
};
...
export const getAdminTeamdata = async (id) => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/get-all-team-data', {
			method: 'get',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const getAdminCompanydata = async (id) => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/get-all-company-data', {
			method: 'get',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const AdminAddRoundDetail = async (data) => {
	...
	return new Promise((resolve, reject) => {
		const req = axios.post(process.env.NEXT_PUBLIC_API_URL + '/admin-add-round-details', data, headers);
		req.then((res) => resolve(res.data)).catch((err) => reject(err));
	});
};
...
export const AdminAddProducts = async (data) => {
	...
	return new Promise((resolve, reject) => {
		const req = axios.post(process.env.NEXT_PUBLIC_API_URL + '/admin-add-products', data, headers);
		req.then((res) => resolve(res.data)).catch((err) => reject(err));
	});
};
...
export const AdminUpdateProduct = async (data) => {
	...
	return new Promise((resolve, reject) => {
		const req = axios.post(process.env.NEXT_PUBLIC_API_URL + '/admin-update-products', data, headers);
		req.then((res) => resolve(res.data)).catch((err) => reject(err));
	});
};
...
export const getAdminProductdata = async (id) => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/get-all-product-data', {
			method: 'get',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const deleteCompany = async (id) => {
	return new Promise((resolve, reject) => {
		const req = axios.post(process.env.NEXT_PUBLIC_API_URL + '/company-delete/' + id, {
			method: 'post',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const deleteProduct = async (id) => {
	return new Promise((resolve, reject) => {
		const req = axios.post(process.env.NEXT_PUBLIC_API_URL + '/product-delete/' + id, {
			method: 'post',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const deleteTeam = async (id) => {
	return new Promise((resolve, reject) => {
		const req = axios.post(process.env.NEXT_PUBLIC_API_URL + '/team-delete/' + id, {
			method: 'post',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const getAllCCSPCampaign = async (id) => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/get-all-campaign', {
			method: 'get',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const getAllCampaignDetaildata = async (id) => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/get-all-campaign-detail-data', {
			method: 'get',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const AdminAddFundNameAndImage = async (data) => {
	...
	return new Promise((resolve, reject) => {
		const req = axios.post(process.env.NEXT_PUBLIC_API_URL + '/admin-add-fundName', data, headers);
		req.then((res) => resolve(res.data)).catch((err) => reject(err));
	});
};
...
export const getCCSPCampaignForStartup = async (id) => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/get-ccsp-detail-for-startup/' + id, {
			method: 'get',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const getAllBlogs = async (data) => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/get-all-blogs', {
			method: 'get',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const getAllBlogCategories = async (data) => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/get-blog-category', {
			method: 'get',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const EditAndSaveBlogData = async (data, image, author_image) => {
	...
	return new Promise((resolve, reject) => {
		const req = axios.post(process.env.NEXT_PUBLIC_API_URL + '/edit-and-save-blog-data', formdata, {
			method: 'post',
			headers: {
				Accept: 'application/json',
				'Content-Type': `multipart/form-data; boundary=${formdata._boundary}`,
...
export const deleteblog = async (data) => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/delete-blog', {
			method: 'post',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
...
export const getAllContactQueries = async (data) => {
	return new Promise((resolve, reject) => {
		const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/all-contact-queries', {
			method: 'get',
			headers: {
				Accept: 'application/json',
				Authorization: 'Bearer ' + getToken()
